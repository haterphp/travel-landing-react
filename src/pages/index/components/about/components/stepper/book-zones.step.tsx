...
function BookZonesStep({ControlPanel}: StepProps) {
    ...
    return (
        <Box className={stepContent}>
            <Typography variant={"h3"} marginBottom={3}>Резервируйте конкретные зоны для посещение</Typography>
...
export default {
    label: "Резервируйте конкретные зоны для посещение",
    component: BookZonesStep
};
